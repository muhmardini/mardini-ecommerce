...
export const Category = () => {
    return (
        <section className="flex flex-col items-center bg-gray-50 pb-10">
            ...
            <motion.div variants={container} viewport={{once: true, amount: 0.4}} initial="hidden" whileInView="show" className="grid md:grid-cols-4 grid-cols-2 gap-x-8 md:gap-x-32 gap-y-12 mt-10 perspective-[1000px]">
                {categories.map(e => (
