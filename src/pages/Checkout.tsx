        ...
        {items.length >= 1 ? (
          ...
          <div className="flex flex-col items-center -mt-10">
            <h1 className="text-secondary text-center">
              There is no Items in the cart yet to checkout, You may deleted all
              your cart products, go to{" "}
              <Link
              ...
              page and add new ones
            </h1>
            <img className="w-3/4 md:w-1/3 " src="/images/no-data.png" alt="" />
          </div>
        )}
      </main>
